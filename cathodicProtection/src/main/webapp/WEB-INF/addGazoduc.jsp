...
<head>
	...
	<title>add Gazoduc <c:out value="${user.firstName}"/> <c:out value="${user.lastName}"/></title>
...
<body>
	...
	<div class="d-flex align-items-center justify-content-center">
        <form:form action="/addGazoduc/new" method="post" modelAttribute="gazoduc" class="col-4 bg-light p-4 my-3 text-dark">
        	<div class="form-row">
				<form:errors path="user" class="error"/>
				<form:input type="hidden" path="user" value="${user.id}" class="form-control"/>
			</div>
            <h2 class="text-dark text-center">Ajouter un Gazoduc</h2>
            <div class="py-3">
            	<div class="row mb-3">
