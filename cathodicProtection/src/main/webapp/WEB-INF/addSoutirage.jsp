...
<head>
	...
	<title>add Soutirage <c:out value="${user.firstName}"/> <c:out value="${user.lastName}"/></title>
...
<body>
	...
	<div class="d-flex align-items-center justify-content-center">
        <form:form action="/addSoutirage/new" method="post" modelAttribute="soutirage" class="col-4 bg-light p-4 my-3 text-dark">
        	<div class="form-row">
				<form:errors path="user" class="error"/>
				<form:input type="hidden" path="user" value="${user.id}" class="form-control"/>
			</div>
            <h2 class="text-dark text-center">Ajouter un Poste de Soutirage</h2>
            <div class="py-3">
            	<div class="row mb-3">
            		<form:label path="emplacement" class="col-sm-3 col-form-label">Emplacement:</form:label>
            		<div class="col-sm-8">
		  		...
		  		<div class="row mb-3">
            		<form:label path="vsmax" class="col-sm-3 col-form-label">Vs max(V):</form:label>
            		<div class="col-sm-8">
            	...
            	<div class="row mb-3">
            		<form:label path="ismax" class="col-sm-3 col-form-label">Is max(A):</form:label>
            		<div class="col-sm-8">
	  			...
	  			<div class="row mb-3">
					<form:label path="marque" class="col-sm-3 col-form-label">Fabricant:</form:label>
					<div class="col-sm-8">
						<form:errors path="marque" class="text-danger"/>
			  			<form:input type="text" step="0.01" min="3"  path="marque" class="form-control"/>
	  				</div>	
	  			</div>
	  			<button type="submit" class="btn btn-primary float-end mx-5">Ajouter</button>
	  		</div>
	  	</form:form>
    </div>
