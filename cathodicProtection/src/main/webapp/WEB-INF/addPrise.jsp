...
<body>
	...
	<form:form action="/gazoducs/addPrise/new" method="post" modelAttribute="prise" class="bg-light p-4 my-3 text-dark">
           <h2 class="text-dark text-center">Ajout d'une prise des mesures</h2>
           <div class="form-group text-danger font-monospace">
            ...
            <div class="row g-3 mx-auto">
                <div class="col-md-3">
                    <form:label path="gazoduc" class="form-label">Gazoduc:</form:label>
                    <form:select path="gazoduc" class="form-select" id="validationDefault04" required="required">
                        <form:option value="" disabled="disabled" selected="selected">Choisir...</form:option>
                        <c:forEach var="gazoduc" items="${gazoducsByuser}">
                        	<form:option value="${gazoduc.id}">${gazoduc.antenne}</form:option>
                        </c:forEach>
                    </form:select>
                </div>
            </div>
