...
<body>
	...
	<div class="d-flex align-items-center justify-content-center">
        <form:form action="/soutirages/${soutirage.id}/addParametre" method="post" modelAttribute="parametre" class="col-6 bg-light p-4 my-3 text-dark">
            ...
            <div class="py-3">
            	...
            	<div class="row mb-3">
	 			...
	 			<div class="d-flex justify-content-end mt-4">
	  				...
	  				<button type="submit" class="btn btn-primary float-end mx-5">Valid Add</button>
	  			</div>
	  		</div>
	  	</form:form>
    </div>
